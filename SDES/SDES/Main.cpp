...
int main()
{
	...
	do
	{
		...
		case 2:
			...
			if (BitCheck(pt_array, 8) == true && BitCheck(EightBitKeyRay1, 8) == true && BitCheck(EightBitKeyRay2, 8) == true)
			{
				if (inputStr.length() == 8 && EightBitKey1.length() == 8 && EightBitKey2.length() == 8)
				{
					Decryption(pt_array, EightBitKeyRay1, EightBitKeyRay2);
					done = true;
				}
